...
@click.option("-p", "--parquet-fn", help="Parquet file to peek", type=str, required=True)
@click.option("-l", "--lines-to-show", help="how many lines to show", type=int, default = 10)
@click.option(
    "-w",
    "--width",
